...
{
	std::cout << "Default RobotomyRequestForm has been constructed" << std::endl;
...
RobotomyRequestForm::RobotomyRequestForm(std::string newTarget) 
	: _target(newTarget), Form("RobotomyRequestForm", 72, 45)
{
	std::cout << newTarget << "RobotomyRequestForm has been constructed" << std::endl;
}
